(function () {
    ...
    function HomeAccountController ($scope, $location, $modal, $route, coreProvider) {
    ...
    gae2App.controller("HomeAccountController", HomeAccountController);


//gae2App.controller("ModalInstanceController", ModalInstanceController);
