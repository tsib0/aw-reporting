(function () {
    function RawDataController2 ($scope, $location, $routeParams, $timeout, $filter, coreProvider, ngTableParams) {
    ...
    awrcApp.controller("RawDataController2", RawDataController2);
